              ...
              <form>
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" placeholder="Nhập giá sản phẩm">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <label for="exampleInput">Phí vận chuyển</label>
                    <input class="form-control" type="text" placeholder="Nhập phí vận chuyển">
                  </div>
                  <div class="form-group">
                    <label for="exampleInput">Tổng tiền</label>
                    <input class="form-control" type="text" placeholder="Nhập tổng số tiền phải thanh toán">
                  </div>
                  <div class="form-group">
